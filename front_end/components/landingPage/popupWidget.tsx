  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-slate-700 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-slate-800 focus:bg-slate-800 ease">
            ...
            <Transition
              ...
              <div className="fixed z-50 bottom-[100px] top-0 right-0 left-0 sm:top-auto sm:right-5 sm:left-auto">
                <Disclosure.Panel className="flex flex-col overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                  <div className="flex flex-col items-center justify-center h-32 p-5 bg-slate-700">
                  ...
                  <div className="flex-grow h-full p-6 overflow-auto bg-gray-50">
                    {!isSubmitSuccessful && (
                      <form onSubmit={handleSubmit(onSubmit)} noValidate>
                          ...
                          <input
                            ...
                            className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring ${
                              errors.name
                                ...
                                : "border-gray-300 focus:border-slate-400 ring-slate-200"
                            }`}
                          />
                          {errors.name && (
                        ...
                        <div className="mb-3">
                          <button
                            type="submit"
                            className="w-full px-3 py-4 text-white bg-slate-700 rounded-md hover:bg-slate-800 focus:bg-slate-800 focus:outline-none">
                            {isSubmitting ? (
                              <svg
                    ...
                    {isSubmitSuccessful && isSuccess && (
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <button
                          className="mt-6 text-slate-600 focus:outline-none"
                          onClick={() => reset()}>
                          Go back
                        </button>
                      </div>
